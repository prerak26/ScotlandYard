			...
			*/
			...
			while(true){
				...
				if (this.id == -1 && !this.registered){
                        ...
                        //this.board.moderatorEnabler.aquire();                      
				...
				*/
				...
				//System.out.println(this.id +" "+ target);
				/*
				...
				*/
				if (!this.registered){
					...
					this.board.threadInfoProtector.release();
					// if(this.board.reentry.tryAcquire()){
					// 	this.registered=true;
					// }

					// else if(this.board.registration.tryAcquire()){
					// 	if(this.board.dead){
					// 		this.board.erasePlayer(this.id);
					// 		input.close();
					// 		output.close();
				...
				*/
				//System.out.println("Part3"+" "+this.id);
                if(quit){
					...
					if(this.id==-1){
						//System.out.println("Part121"+" "+this.id);
						this.board.moveFugitive(target);
					}
					else{
						//System.out.println("Part122"+" "+this.id);
				...
				*/
				...
				this.board.count++;
				//System.out.println("count inc" + this.board.playingThreads); 
				...
				*/
				...
				//System.out.println("barrier2 by "+this.id );
